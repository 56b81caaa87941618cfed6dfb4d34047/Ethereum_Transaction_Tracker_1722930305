...
Vue.component("simple_header_component_1722930307", {
    template: `
            ...
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home"><a href="#" class="block py-2 pl-3 pr-4 text-white bg-purple-700 rounded-lg lg:bg-transparent lg:text-purple-300 lg:p-0 dark:text-white hover:bg-purple-600 lg:hover:bg-transparent lg:hover:text-white transition-colors duration-200" aria-current="page">Latest Ethereum Transactions</a></li>
                        <li id="nav-item-1"><a href="#" class="block py-2 pl-3 pr-4 text-gray-300 rounded-lg hover:bg-purple-600 lg:hover:bg-transparent lg:hover:text-white lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent transition-colors duration-200">Transaction Hash Details</a></li>
                        <li id="nav-item-2"><a href="#" class="block py-2 pl-3 pr-4 text-gray-300 rounded-lg hover:bg-purple-600 lg:hover:bg-transparent lg:hover:text-white lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent transition-colors duration-200">Sender and Receiver Addresses</a></li>
                        <li id="nav-item-3"><a href="#" class="block py-2 pl-3 pr-4 text-gray-300 rounded-lg hover:bg-purple-600 lg:hover:bg-transparent lg:hover:text-white lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent transition-colors duration-200">Gas Fees and Block Information</a></li>
                    </ul>
                </div>
            </div>
        </nav>
